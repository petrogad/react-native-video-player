...
export default class VideoPlayer extends Component {
  ...
  rewind() {
    const seekTo = (this.state.currentTime - this.props.rewindInSeconds);
    this.seek(seekTo);
  }
  ...
  renderControls() {
    ...
    return (
      <View style={[styles.controls, customStyles.controls]}>
        <TouchableOpacity
          onPress={this.rewind}
          style={[customStyles.controlButton, customStyles.rewindControl]}
        >
          <Icon
            style={[styles.controlIcon, customStyles.controlIcon, customStyles.rewindIcon]}
            name={'replay'}
            size={32}
          />
        </TouchableOpacity>
        ...
        >
          <Icon
            style={[styles.controlIcon, customStyles.controlIcon, customStyles.playIcon]}
        ...
        {this.props.muted ? null : (
          <TouchableOpacity onPress={this.onMutePress} style={customStyles.controlButton}>
            <Icon
              style={[styles.controlIcon, customStyles.controlIcon]}
